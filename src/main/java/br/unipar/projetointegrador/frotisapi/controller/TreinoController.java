...
public class TreinoController {
    ...
    public TreinoController(TreinoService treinoService, TreinoRepository treinoRepository) {
    ...
    public ResponseEntity<List<TreinoDTO>> listarTreinosSemFicha() {
        // Agora o treinoRepository existe nesta classe!
        List<Treino> treinos = treinoRepository.findTreinosSemFicha();
